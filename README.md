...
- [Git rebase로 협업 고수되기](https://yangeok.github.io/git/2020/10/24/git-rebase.html)
...
- [초보를 위한 도커 안내서 - 설치하고 컨테이너 실행하기 series(2)](https://subicura.com/2017/01/19/docker-guide-for-beginners-2.html)
- [초보를 위한 도커 안내서 - 이미지 만들고 배포하기 series(3)](https://subicura.com/2017/02/10/docker-guide-for-beginners-create-image-and-deploy.html)

### Kubernetes
- [Kubernetes(쿠버네티스)를 소개합니다](https://deveric.tistory.com/103)

### AWS
- [AWS WAF 운영에 대한 이야기](https://woowabros.github.io/security/2020/10/15/woowa-aws-waf.html)
...
#### React
- [한국어로 ](https://github.com/reactkr/learn-react-in-korean)
...
- [서버 개발 인턴 robin의 성장기](https://tech.kakao.com/2020/04/24/2019-internship-robin/)
- [코딩으로 한 달만에 월급 2배의 매출을 낸 썰](https://blog.naver.com/nanotoly/222141085487)
